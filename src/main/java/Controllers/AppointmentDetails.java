...
public class AppointmentDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name = request.getParameter("selectedDoctor");
        String date = request.getParameter("appointmentDate");
        String selectedSlot = request.getParameter("selectedSlot");
        String serviceType = request.getParameter("serviceType");
        String customerName = request.getParameter("customerName");

        slots = app.formatSelectedSlot(selectedSlot);
        Event event = new Event(name, date, slots[0], slots[1], customerName, serviceType);
        app.addAppointmentToDatabase(event);
