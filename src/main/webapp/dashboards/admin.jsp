            ...
            <details>
                ...
                <form method="post" id="updateUser">
                    ...
                    <div id="table">
                        ...
                        <br>
                        <button id="blueButton" type="submit" name="action" form="updateUser" value="update-selected">Edit Selected</button>
                    </div>
                </form>
            ...
            <details>
                ...
                <form method="post">
                    ...
                    <c:if test="${requestScope.approvals.size() > 0}">
                        ...
                        <br>
                        <button type="submit" id="blueButton" value="submit-approvals" name="action">Submit Account Approvals</button>
                    </c:if>
                </form>
            </details>
            <details>
            ...
            <details>
                ...
                <form method="post" id="delete">
                    <div id="table">
                        ...
                        <br>
                        <button id="pinkButton" type="submit" name="action" value="delete-selected" form="delete">Delete Selected</button>
                    </div>
                </form>
            </details>
            <details>
